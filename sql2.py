...
BEGIN
    CREATE TABLE Flood_Map_Data (
        ...
        area_sq_km FLOAT NULL,         -- Added area_sq_km
    ...
    try:
        ...
        with open(OUTPUT_SQL, "w") as out:
            ...
            for i, feature in enumerate(data['features'], 1):
                ...
                area = props.get('area_sq_km', 'NULL')  # Added area_sq_km

                # Format the INSERT statement for Azure SQL Geometry
                sql_line = (
                    f"INSERT INTO Flood_Map_Data (flooded, depth_class, polygon_id, area_sq_km, geometry) "
                    f"VALUES ({flooded}, {d_class}, {poly_id}, {area if area is not None else 'NULL'}, "
...
if __name__ == "__main__":
    generate_sql_commands("flood_depth_bbaynorth_05th.geojson", "upload_data_05th.sql")
    generate_sql_commands("flood_depth_bbaynorth_50th.geojson", "upload_data_50th.sql")
    generate_sql_commands("flood_depth_bbaynorth_95th.geojson", "upload_data_95th.sql")